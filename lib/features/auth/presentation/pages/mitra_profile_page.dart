              ...
              child: Column(
                children: [
                  _MenuItem(
                    ...
                    label: 'Gudang Saya',
                    onTap: () => context.push(RouteConstants.mitraWarehouses),
                  ),
                  const Divider(height: 1),
                  _MenuItem(
                    icon: Icons.bar_chart,
                    label: 'Laporan Pendapatan',
                    onTap: () => context.push(RouteConstants.mitraRevenueReport),
                  ),
                  const Divider(height: 1),
                  _MenuItem(
                    icon: Icons.notifications_outlined,
                    label: 'Notifikasi',
                    onTap: () => context.push(RouteConstants.mitraNotifications),
                  ),
                  const Divider(height: 1),
                  _MenuItem(
                    icon: Icons.help_outline,
                    label: 'Bantuan',
                    onTap: () => context.push(RouteConstants.mitraHelp),
                  ),
                ],
              ),
            ),
