        ...
        if (state is AuthStateRegistering) {
          if (state.exception is WeakPasswordAuthException) {
            await showErrorDialog(
              context, 'Password lemah'
            );
          } else if (state.exception is EmailAlreadyInUseAuthException) {
            await showErrorDialog(
              context, 'Email sudah digunakan'
            );
          } else if (state.exception is GenericAuthException) {
            await showErrorDialog(
              context, 'Gagal register'
            );
      ...
      child: Scaffold(
        ...
        body: Padding(
          ...
          child: Column(
            ...
            children: [
              const Text(
                'Silahkan masukkan email dan password untuk melihat catatanmu',
              ),
              TextField(
                controller: _email,
                ...
                child: Column(
                  children: [
                    ...
                    TextButton(
                      ...
                      child: const Text('Sudah Register? Login di sini'),
                    ),
                  ],
                ),
              ),
