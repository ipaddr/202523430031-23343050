...
import 'package:app1/utilities/dialogs/loading_dialog.dart';
      ...
      listener: (context, state) async{
        if (state is AuthStateLoggedOut) {
          if (state.exception is UserNotFoundAuthException) {
            ...
            await showErrorDialog(context, 'Email atau password salah');
      ...
      child: Scaffold(
        ...
        body: Padding(
          ...
          child: Column(
            children: [
              const Text(
                'Silahkan masuk dengan email dan password yang sudah terdaftar',
              ),
              TextField(
                controller: _email,
              ...
              TextButton(
                ...
                child: const Text('Saya lupa password'),
              ),
              TextButton(
                onPressed: () {
                  context.read<AuthBloc>().add(
